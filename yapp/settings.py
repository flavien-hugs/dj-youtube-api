...
SITE_NAME = 'Youtube API Search'
SITE_DESCRIPTION = "Manipulation de l'API de Youtube"
META_KEYWORDS = 'Youtube, Rechercher, Search, Vidéos, Learn, Learning, tutoriels, apprendre'
...
WSGI_APPLICATION = 'yapp.wsgi.application'
